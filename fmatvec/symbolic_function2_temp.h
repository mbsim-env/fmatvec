...
#ifdef PARDER1
  pd1.assign(fmatvec::parDer(retS, arg1S));
#endif
  dd1.assign(fmatvec::dirDer(retS, argDir1S, arg1S));
#ifdef PARDER2
  pd2.assign(fmatvec::parDer(retS, arg2S));
#endif
  dd2.assign(fmatvec::dirDer(retS, argDir2S, arg2S));
#ifdef PARDER1PARDER1
  pd1pd1.assign(fmatvec::parDer(fmatvec::parDer(retS, arg1S), arg1S));
#endif
#ifdef PARDER1
  pd1dd1.assign(fmatvec::dirDer(fmatvec::parDer(retS, arg1S), argDir1S, arg1S));
#endif
  dd1dd1.assign(fmatvec::dirDer(fmatvec::dirDer(retS, argDir1S, arg1S), argDir1S_2, arg1S));
#ifdef PARDER2PARDER2
  pd2pd2.assign(fmatvec::parDer(fmatvec::parDer(retS, arg2S), arg2S));
#endif
#ifdef PARDER2
  pd2dd2.assign(fmatvec::dirDer(fmatvec::parDer(retS, arg2S), argDir2S, arg2S));
#endif
  dd2dd2.assign(fmatvec::dirDer(fmatvec::dirDer(retS, argDir2S, arg2S), argDir2S_2, arg2S));
#ifdef PARDER1PARDER2
  pd1pd2.assign(fmatvec::parDer(fmatvec::parDer(retS, arg1S), arg2S));
#endif
#ifdef PARDER1
  pd1dd2.assign(fmatvec::dirDer(fmatvec::parDer(retS, arg1S), argDir2S, arg2S));
#endif
  dd2dd1.assign(fmatvec::dirDer(fmatvec::dirDer(retS, argDir2S, arg2S), argDir1S, arg1S));
#ifdef PARDER2
  pd2dd1.assign(fmatvec::dirDer(fmatvec::parDer(retS, arg2S), argDir1S, arg1S));
#endif
}
