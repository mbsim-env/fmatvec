...
namespace fmatvec {
 ...
 /// @endcond
	...
	ele = new AT[M*N];
       ...
       * */
      template <class Type, class Row, class Col>
      inline Matrix<General,Var,Fixed<N>,AT>& assign(const Matrix<Type,Row,Col,AT> &A) {
        assert(N == A.cols());
       ...
       * */
      template <class Type, class Row, class Col>
      inline Matrix<General,Var,Fixed<N>,AT>& reassign(const Matrix<Type,Row,Col,AT> &A) {
        assert(N == A.cols());
