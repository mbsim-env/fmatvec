...
//      Matrix(int m, int n) {};
  ...
  template <class Type, class Row, class Col, class AT> class SquareMatrix {
  };

  template <class Type, class Row, class Col, class AT> class Vector {
  };

  template <class Type, class Row, class Col, class AT> class RowVector {
  };
}
