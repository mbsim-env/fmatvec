...
namespace fmatvec {
  ...
  template <class AT> class Vector<General, AT>;
  template <class AT> class RowVector<General, AT>;
  template <class AT> class SquareMatrix<General, AT>;
 ...
 /// @endcond
	...
	return operator<<(A);
       ...
       * \return A reference to the calling matrix.
       * */
      inline Matrix<General, AT>& operator>>(const Matrix<General, AT> &A);
  ...
  return (tp)? CblasTrans : CblasNoTrans;
	...
	return  CblasColMajor;
       ...
       * \return A submatrix of the calling matrix.
       * */
      inline Matrix<General, AT> operator()(const Index &I, const Index &J);

      /*! \brief Submatrix operator.
       *
       * See operator()(const Index&, const Index&)
       * */
      inline const Matrix<General, AT> operator()(const Index &I, const Index &J) const;
       ...
       * \return A submatrix of the calling matrix.
       * */
      inline SquareMatrix<General, AT> operator() (const Index &I);

      /*! \brief Submatrix operator.
       *
       * See operator()(const Index&)
       * */
      inline const SquareMatrix<General, AT> operator()(const Index &I) const;
       ...
       * */
      inline Vector<General, AT> col(int i);

      /*! \brief Column operator.
       *
       * see col(int)
       * */
      inline const Vector<General, AT> col(int i) const;
       ...
       * */
      inline RowVector<General, AT> row(int i); 

      /*! \brief Row operator.
       *
       * see row(int)
       * */
      inline const RowVector<General, AT> row(int i) const;
       ...
       * */
      inline Matrix<General, AT> copy() const;
       ...
       * \return A reference to the calling matrix.
       * */
      inline Matrix<General, AT>& init(const AT &a);
  ...
  template <class AT>
    inline Matrix<General, AT>& Matrix<General, AT>::operator>>(const Matrix<General, AT> &A) { 
  ...
  template <class AT> template< class Type>
    inline Matrix<General, AT>& Matrix<General, AT>::operator<<(const Matrix<Type, AT> &A) { 
  ...
  template <class AT>
    inline Matrix<General, AT>&  Matrix<General, AT>::init(const AT& val) {
  ...
  template <class AT> 
    inline Matrix<General, AT> Matrix<General, AT>::operator()(const Index &I, const Index &J) {
#ifndef FMATVEC_NO_BOUNDS_CHECK
      assert(I.end()<m);
      assert(J.end()<n);
#endif
  ...
  template <class AT> 
    inline const Matrix<General, AT> Matrix<General, AT>::operator()(const Index &I, const Index &J) const {
#ifndef FMATVEC_NO_BOUNDS_CHECK
      assert(I.end()<m);
      assert(J.end()<n);
#endif
  ...
  template <class AT> 
    inline const SquareMatrix<General, AT> Matrix<General, AT>::operator()(const Index &I) const {
#ifndef FMATVEC_NO_BOUNDS_CHECK
      assert(I.end()<m);
#endif
  ...
  template <class AT>
    inline SquareMatrix<General, AT> Matrix<General, AT>::operator()(const Index &I) {
#ifndef FMATVEC_NO_BOUNDS_CHECK
      assert(I.end()<m);
#endif
      return SquareMatrix<General, AT>(I.end()-I.start()+1,lda,tp,memory,elePtr(I.start(),I.start()));
  ...
  template <class AT>
    inline Vector<General, AT>  Matrix<General, AT>::col(int i) {
      ...
      return Vector<General, AT>(m,lda,tp,memory,elePtr(0,i));
    }

  template <class AT>
    inline const Vector<General, AT>  Matrix<General, AT>::col(int i) const {
  ...
  template <class AT>
    inline RowVector<General, AT>  Matrix<General, AT>::row(int i) {
      ...
      return RowVector<General, AT>(n,lda,tp,memory,elePtr(i,0));
    }

  template <class AT>
    inline const RowVector<General, AT>  Matrix<General, AT>::row(int i) const {
  ...
  template <class AT>
    inline Matrix<General, AT> Matrix<General, AT>::copy() const {
  ...
  template <class AT>
    inline Matrix<General, AT>::operator std::vector<std::vector<AT> >() {
  ...
  template <class AT>
    inline Matrix<General, AT>::Matrix(std::vector<std::vector<AT> > m) : memory(m.size()*m[0].size()), ele((AT*)memory.get()), m(m.size()), n(m[0].size()), lda(m.size()), tp(false) {
#ifndef FMATVEC_NO_INITIALIZATION 
      init(0);
#endif
      for(int r=0; r<rows(); r++) {
